...
def test_project_schema_dump_one_dict_many_false(project_schema: ProjectSchema, deserialized_project: Project,
                                                 serialized_project: dict):
    assert project_schema.dump(deserialized_project) == serialized_project


def test_project_schema_dump_one_dict_many_true(project_schema: ProjectSchema, deserialized_project: Project,
                                                serialized_project: dict):
...
def test_project_schema_load_one_dict_many_false(project_schema: ProjectSchema, deserialized_project: Project,
                                                 serialized_project: dict):
    assert project_schema.load(serialized_project) == deserialized_project


def test_project_schema_load_one_dict_many_true(project_schema: ProjectSchema, deserialized_project: Project,
                                                serialized_project: dict):
