...
def test_annotation_schema_dump_one_dict_many_false(
    annotation_schema: AnnotationSchema, deserialized_annotation: Annotation, serialized_annotation: dict
):
...
def test_annotation_schema_dump_list_many_true(
    annotation_schema: AnnotationSchema, deserialized_annotation: Annotation
):
...
def test_annotation_schema_load_null_datetime_as_none(annotation_schema: AnnotationSchema, serialized_annotation: dict):
